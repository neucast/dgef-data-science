...
print("\nMethod 1: Ridge lambda compute by Time series split with Grid-Search cross validation.")
...
print("\nMethod 2: Ridge lambda compute by sklearn.linear_model Ridge cross validation.")
